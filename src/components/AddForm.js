                    ...
                    {hasDependents ? 
                        employee.Dependents.map((dependent) => (
                            <div key={dependent.Id} className="row my-2">
                                <div className="col-3">
                                    <input className="form-control form-control-lg" type="text" value={dependent.Name} onChange={e => handleDependentNameChange(e.target.value,dependent.Id)} placeholder="Dependent Name"/>
                                </div>
                                <div className="col-3">
                                    <div className="form-check form-control-lg">
